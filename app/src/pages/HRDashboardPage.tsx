...
const [employees, setEmployees] = useState<Employee[]>([])
  ...
  return (
    <div>
      <Breadcrumb items={[{ label: tNav('groups.dashboards') }, { label: tNav('groups.hr') }]} />
