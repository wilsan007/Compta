  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('components.empty')} /> : (
        <Table headers={[t('components.code'), t('components.name'), t('components.type'), t('components.calcType'), t('components.active'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('templates.empty')} /> : (
        <Table headers={[t('templates.name'), t('templates.category'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('advances.empty')} /> : (
        <Table headers={[t('advances.employee'), t('advances.amount'), t('advances.date'), t('advances.status'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('dsn.empty')} /> : (
        <Table headers={[t('dsn.period'), t('dsn.type'), t('dsn.status'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('legalWatch.empty')} /> : (
        <Table headers={[t('legalWatch.title'), t('legalWatch.category'), t('legalWatch.date'), t('legalWatch.relevance'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('expenseReports.empty')} /> : (
        <Table headers={[t('expenseReports.number'), t('expenseReports.employee'), t('expenseReports.amount'), t('expenseReports.status'), tCommon('common.actions')]}>
  ...
  return (
    <div>
      ...
      {loading ? <SkeletonTable /> : items.length === 0 ? <EmptyState title={t('interviews.empty')} /> : (
        <Table headers={[t('interviews.employee'), t('interviews.type'), t('interviews.date'), t('interviews.status'), tCommon('common.actions')]}>
