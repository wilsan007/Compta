...
export function MCFPage() {
  ...
  async function handleDelete(id: string) { if (!window.confirm(tCommon('common.confirmDelete'))) return; try { await deleteFutureAccountingMovement(id); await loadData() } catch (e: any) { toast('error', tCommon('common.error'), e.message) } }
...
export function TreasuryTransfersPage() {
  ...
  async function handleDelete(id: string) { if (!window.confirm(tCommon('common.confirmDelete'))) return; try { await deleteTreasuryTransfer(id); await loadData() } catch (e: any) { toast('error', tCommon('common.error'), e.message) } }
...
export function CreditLinesPage() {
  ...
  async function handleDelete(id: string) { if (!window.confirm(tCommon('common.confirmDelete'))) return; try { await deleteCreditLine(id); await loadData() } catch (e: any) { toast('error', tCommon('common.error'), e.message) } }
...
export function InvestmentsPage() {
  ...
  async function handleDelete(id: string) { if (!window.confirm(tCommon('common.confirmDelete'))) return; try { await deleteInvestment(id); await loadData() } catch (e: any) { toast('error', tCommon('common.error'), e.message) } }
...
export function TreasuryRecurringPage() {
  ...
  async function handleDelete(id: string) { if (!window.confirm(tCommon('common.confirmDelete'))) return; try { await deleteTreasuryRecurring(id); await loadData() } catch (e: any) { toast('error', tCommon('common.error'), e.message) } }
