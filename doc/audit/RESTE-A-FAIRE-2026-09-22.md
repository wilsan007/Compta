...
- **À faire** : RPC `post_payroll_payment(pay_run_id, bank_account_id, date)` ; lettrage 421 par salarié (auxiliaire salarié à créer) ; déclenchement au passage à « payé » ou par bouton ; scénarios P08 et P09.
- **Effort** : 1,5 j.
