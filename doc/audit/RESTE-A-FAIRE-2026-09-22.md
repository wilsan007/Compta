...
| D-6 | Rôles utilisateurs (7 politiques RLS sur 2 296 regardent le rôle) | ✅ **tranchée le 24/09 par la 239, en deux temps mesurés** : le rôle devient opposable sur les **41 tables** où l'argent, les personnes et la comptabilité circulent (123 politiques d'écriture gardées par `can_perform`, 9 scénarios) ; les **257 autres tables écrites** restent sous la garde de société seule, **chiffrées et publiées** à chaque exécution par `ci/check_roles_opposables.sql` — la généralisation se poursuit par tranches, sans jamais cacher le reste. Preuves : `doc/audit/VAGUE-W1-ISO02-04-PERM01-2026-09-24.md` | H08 |
